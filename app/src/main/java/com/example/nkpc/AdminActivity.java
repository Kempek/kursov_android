    ...
    public class AdminActivity extends AppCompatActivity {
        ...
        private static final String ADD_PRODUCT_URL = "https://oplata-test.ru/kursav/add_product.php";
        private static final String GET_PRODUCTS_URL = "https://oplata-test.ru/kursav/get_products_admin.php";
        ...
        private class DeleteProductTask extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    URL url = new URL("https://oplata-test.ru/kursav/delete_product.php"); // Замените на ваш URL для удаления
                    HttpURLConnection connection = (HttpURLConnection) url.openConnection();
                    connection.setRequestMethod("POST");
                    connection.setDoOutput(true);
        ...
        private class EditProductTask extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    URL url = new URL("https://oplata-test.ru/kursav/edit_product.php"); // Замените на ваш URL для редактирования
                    HttpURLConnection connection = (HttpURLConnection) url.openConnection();
                    connection.setRequestMethod("POST");
                    connection.setDoOutput(true);
